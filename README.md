...
- [Электрическая принципиальная схема](./docs/ElectricalDiagram.png)
...
**Подключение NPN транзистора C1815**  
![C1815](./docs/C1815.png)  
...
**Важно:** HY-SRF05 возвращает сигнал 5В с ECHO, а STM32F103C8T6 работает с логикой 3.3В, поэтому необходимо снизить напряжение с помощью делителя:  
![SRF05](./docs/SRF05.png)  
